...
export default function FlipkartWizard({
  open,
  onClose,
  onConnected,
}: FlipkartWizardProps) {
  ...
  const TEST_MESSAGES = [
    ...
    "Connecting to Flipkart Seller API...",
  ...
  useEffect(() => {
    ...
    const hasEmptyFields = !appId.trim() || !appSecret.trim();
    if (hasEmptyFields) {
  ...
  const handleSuccess = () => {
    onConnected(sellerId || "Flipkart Store", "Flipkart.in");
    reset();
    onClose();
  };
  ...
  return (
    ...
    >
      <motion.div
        ...
        data-ocid="flipkart_wizard.modal"
      >
        {step !== 4 && (
          <button
            type="button"
            ...
            data-ocid="flipkart_wizard.close_button"
          >
            <X size={14} />
          </button>
        )}
          ...
          {step === 1 && (
            ...
            >
              <div className="flex flex-col items-center text-center mb-6">
                ...
                >
                  Sync orders, inventory, pricing and analytics from your
                  Flipkart store directly into SellerSync Pro.
                </p>
              </div>
              ...
              >
                ...
                >
                  {[
                    ...
                    >
                      <span style={{ color: "#2B6CB0", fontSize: 14 }}>✓</span>
                      {item}
                    </li>
                  ))}
                </ul>
              ...
              <div className="flex flex-col gap-2">
                <button
                  ...
                  data-ocid="flipkart_wizard.primary_button"
                >
                ...
                <button
                  ...
                  data-ocid="flipkart_wizard.cancel_button"
                >
                  Cancel
                </button>
              </div>
              ...
              <div className="flex flex-col gap-4 mb-6">
                <FormField label="Seller ID" required>
                  <input
                    ...
                    placeholder="e.g. FKMP123456"
                    style={inputStyle}
                    data-ocid="flipkart_wizard.input"
                  />
                  <HelperText text="Find in Flipkart Seller Hub > Account > Seller Details" />
                </FormField>
                ...
                >
                  ...
                  >
                    Your Seller ID is available in your Flipkart Seller Hub
                    under Account Settings &gt; Seller Details.
                  </p>
                </div>
              </div>
          ...
          {step === 3 && (
            ...
            >
              ...
              >
                ...
                >
                  Flipkart Seller API Credentials Required
                </p>
                <p
                  style={{
                    margin: "0 0 6px",
                ...
                >
                  Create an API application in Flipkart Seller Hub under
                  Developer Settings, then copy your App ID and App Secret.
                </p>
              ...
              <div className="flex flex-col gap-4 mb-6">
                <FormField label="App ID" required>
                  <input
                    ...
                    placeholder="e.g. fk-app-XXXXXXXXXXXXXXXX"
                    style={{
                      ...inputStyle,
                    ...
                    data-ocid="flipkart_wizard.input"
                  />
                  <HelperText text="Found in Flipkart Seller Hub > Developer Settings > My Apps" />
                </FormField>
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: 60,
                          borderRadius: "50%",
                          border: "3px solid rgba(43,108,176,0.15)",
                          position: "absolute",
                        }}
                      />
                      <div
                      ...
                      >
                        <RefreshCw size={18} style={{ color: "#2B6CB0" }} />
                      </div>
                    </div>
                    <h2
                      style={{
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  ...
                  data-ocid="flipkart_wizard.secondary_button"
                >
