...
export default function ShopifyWizard({
  open,
  onClose,
  onConnected,
}: ShopifyWizardProps) {
  ...
  const handleSuccess = () => {
    onConnected(storeName || "Shopify Store", "myshopify.com");
    reset();
    onClose();
  };
      ...
      >
        ...
        <AnimatePresence mode="wait">
              ...
              <div className="flex flex-col items-center text-center mb-6">
                <div
                  style={{
                    ...
                    height: 60,
                    borderRadius: 16,
                    background: "rgba(150,191,111,0.15)",
                    border: "1px solid rgba(150,191,111,0.35)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    marginBottom: 16,
                ...
                >
                  Sync your Shopify store orders, inventory, and analytics
                  directly into SellerSync Pro.
                </p>
              </div>
              <div
                style={{
                  background: "rgba(150,191,111,0.07)",
                  border: "1px solid rgba(150,191,111,0.2)",
                  borderRadius: 12,
                  padding: "14px 16px",
                  marginBottom: 24,
                }}
              >
                ...
                >
                  {[
                    ...
                    >
                      <span style={{ color: "#96BF6F", fontSize: 14 }}>✓</span>
                      {item}
                    </li>
                  ))}
                </ul>
          ...
          {step === 2 && (
            ...
            >
              <StepHeader
                title="Step 1 of 3: Store Information"
                progress={33}
              />
              <div className="flex flex-col gap-4 mb-6">
                <FormField label="Shopify Store Name" required>
                  <input
                    type="text"
                    value={storeName}
                    ...
                    style={inputStyle}
                  />
                  <HelperText text="Your store subdomain from my-store.myshopify.com" />
                </FormField>
                <div
                  style={{
                ...
                >
                  ...
                  >
                    Create a Private App in your Shopify Admin under Apps &gt;
                    Develop apps to get your API credentials.
                  </p>
                </div>
              </div>
              <StepButtons
          ...
          {step === 3 && (
            ...
            >
              ...
              <div
                style={{
                  background: "rgba(150,191,111,0.07)",
                  border: "1px solid rgba(150,191,111,0.25)",
                  borderRadius: 10,
                  padding: "12px 14px",
                  marginBottom: 20,
                }}
              >
                ...
                >
                  Shopify Admin API Credentials Required
                </p>
                <p
                  style={{
                    margin: "0 0 6px",
                ...
                >
                  Go to Shopify Admin &gt; Apps &gt; Develop apps &gt; Create an
                  app &gt; Configure Admin API access.
                </p>
              ...
              <div className="flex flex-col gap-4 mb-6">
                ...
                <FormField label="API Secret Key" required>
                  <div style={{ position: "relative" }}>
                    <input
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: 60,
                          borderRadius: "50%",
                          border: "3px solid rgba(150,191,111,0.15)",
                          position: "absolute",
                        }}
                      />
                      <div
                      ...
                      >
                        <RefreshCw size={18} style={{ color: "#96BF6F" }} />
                      </div>
                    </div>
                    <h2
                      style={{
            ...
            >
              <div className="flex flex-col items-center text-center mb-6">
                ...
                >
                  <span
                    style={{
                      background: "rgba(150,191,111,0.12)",
                      border: "1px solid rgba(150,191,111,0.3)",
                      borderRadius: 6,
                      padding: "3px 10px",
                      fontSize: 12,
                      color: "#A8D48A",
