...
interface IndiaMartWizardProps {
  open: boolean;
  onClose: () => void;
  onConnected: (sellerId: string, region: string) => void;
}

const SYNC_ITEMS = ["Leads", "Inquiries", "Analytics", "Catalog"];

export default function IndiaMartWizard({
  open,
  onClose,
  onConnected,
}: IndiaMartWizardProps) {
  ...
  const TEST_MESSAGES = [
    ...
    "Connecting to IndiaMart Lead Manager API...",
  ...
  const handleSuccess = () => {
    onConnected(glid || "IndiaMart Store", "IndiaMart.com");
    reset();
    onClose();
  };
              ...
              <div className="flex flex-col items-center text-center mb-6">
                <div
                  style={{
                    ...
                    border: "1px solid rgba(0,130,60,0.35)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    marginBottom: 16,
                ...
                >
                  Connect IndiaMart Lead Manager
                </h2>
                <p
                  style={{
                    color: "#5A7A95",
                ...
                >
                  Sync buyer inquiries, leads, and catalog data from IndiaMart
                  directly into SellerSync Pro.
                </p>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  {[
                    ...
                    >
                      <span style={{ color: "#00823C", fontSize: 14 }}>✓</span>
                      {item}
                    </li>
                  ))}
                </ul>
          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="flex flex-col gap-4 mb-6">
                <FormField label="GLID (Global Listing ID)" required>
                  <input
                    type="text"
                    value={glid}
                    onChange={(e) => setGlid(e.target.value)}
                    placeholder="e.g. IM123456"
                    style={inputStyle}
                  />
                  <HelperText text="Find in IndiaMart Seller Panel > My Account > Business Details" />
                </FormField>
                <FormField label="Business / Store Name" optional>
                  <input
                    type="text"
                    value={storeName}
                ...
                >
                  ...
                  >
                    Your GLID is available in IndiaMart Seller Panel under My
          ...
          {step === 3 && (
            ...
            >
              ...
              >
                ...
                >
                  IndiaMart Lead Manager API Key Required
                </p>
                <p
                  style={{
                    margin: "0 0 6px",
                ...
                >
                  Request your API key from IndiaMart Seller Support or from the
                  Seller Panel under Settings &gt; API Access.
                </p>
                ...
                <FormField label="API Key" required>
                  <div style={{ position: "relative" }}>
                    <input
                      ...
                      placeholder="Your IndiaMart API key"
                      style={{
                        ...inputStyle,
                        paddingRight: 36,
                  ...
                  <HelperText text="Obtained from IndiaMart Seller Support or Settings > API Access" />
                </FormField>
              </div>
              <StepButtons
                onNext={() => setStep(4)}
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: 60,
                          borderRadius: "50%",
                          border: "3px solid rgba(0,130,60,0.15)",
                          position: "absolute",
                        }}
                      />
                      <div
                      ...
                      >
                        <RefreshCw size={18} style={{ color: "#00823C" }} />
                      </div>
                    </div>
                    <h2
                      style={{
                ...
                >
                  <span
                    style={{
                      ...
                      border: "1px solid rgba(0,130,60,0.3)",
                      borderRadius: 6,
                      padding: "3px 10px",
                      fontSize: 12,
                      color: "#34D078",
