...
const TEST_MESSAGES = [
  ...
  "Connecting to eBay Developer API...",
  "Fetching seller profile...",
  "\u2713 Connection successful!",
];

export default function EbayWizard({
  open,
  onClose,
  onConnected,
}: EbayWizardProps) {
  ...
  const [site, setSite] = useState("eBay India");
  ...
  const handleSuccess = () => {
    onConnected(sellerId || "eBay Seller", site);
    reset();
    onClose();
  };
      ...
      >
        ...
        <AnimatePresence mode="wait">
              ...
              <div className="flex flex-col items-center text-center mb-6">
                <div
                  style={{
                    ...
                    height: 60,
                    borderRadius: 16,
                    background: "rgba(86,172,86,0.15)",
                    border: "1px solid rgba(86,172,86,0.35)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    marginBottom: 16,
                ...
                >
                  Sync your eBay store orders, inventory, and analytics directly
                  into SellerSync Pro.
                </p>
              </div>
              <div
                style={{
                  background: "rgba(86,172,86,0.07)",
                  border: "1px solid rgba(86,172,86,0.2)",
                  borderRadius: 12,
                  padding: "14px 16px",
                  marginBottom: 24,
                }}
              >
                ...
                >
                  {[
                    ...
                    >
                      <span style={{ color: "#56AC56", fontSize: 14 }}>✓</span>
                      {item}
                    </li>
                  ))}
                </ul>
          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="flex flex-col gap-4 mb-6">
                <FormField label="eBay Seller ID" required>
                  <input
                    type="text"
                    value={sellerId}
                    onChange={(e) => setSellerId(e.target.value)}
                    placeholder="e.g. my_ebay_username"
                    style={inputStyle}
                  />
                  <HelperText text="Your eBay username used for selling" />
                </FormField>
                ...
                >
                  ...
                  >
                    Create an application in the eBay Developer Program to
          ...
          {step === 3 && (
            ...
            >
              <StepHeader
                title="Step 2 of 3: OAuth Credentials"
                progress={66}
              />
              <div
                style={{
                  background: "rgba(86,172,86,0.07)",
                  border: "1px solid rgba(86,172,86,0.25)",
                  borderRadius: 10,
                  padding: "12px 14px",
                  marginBottom: 20,
                }}
              >
                ...
                >
                  eBay Developer OAuth Credentials Required
                </p>
                <p
                  style={{
                    margin: "0 0 6px",
                ...
                >
                  Register at developer.ebay.com, create an application, and
              ...
              <div className="flex flex-col gap-4 mb-6">
                <FormField label="Client ID (App ID)" required>
                  <input
                    ...
                    placeholder="Your eBay App Client ID"
                    style={inputStyle}
                  />
                </FormField>
                <FormField label="Client Secret" required>
                  ...
                  <HelperText text="Found in eBay Developer Portal > My Account > Application Keys" />
                </FormField>
              </div>
              <StepButtons
                onNext={() => setStep(4)}
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: 60,
                          borderRadius: "50%",
                          border: "3px solid rgba(86,172,86,0.15)",
                          position: "absolute",
                        }}
                      />
                      <div
                      ...
                      >
                        <RefreshCw size={18} style={{ color: "#56AC56" }} />
                      </div>
                    </div>
                    <h2
                      style={{
            ...
            >
              <div className="flex flex-col items-center text-center mb-6">
                ...
                >
                  <span
                    style={{
                      background: "rgba(86,172,86,0.12)",
                      border: "1px solid rgba(86,172,86,0.3)",
                      borderRadius: 6,
                      padding: "3px 10px",
                      fontSize: 12,
                      color: "#7ACC7A",
